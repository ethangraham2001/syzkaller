...
struct KFuzzTargetRaw;
struct KFuzzTargetRawBuilder;
struct KFuzzTargetRawT;
...
struct KFuzzTargetRawT : public ::flatbuffers::NativeTable {
  typedef KFuzzTargetRaw TableType;
  std::string func_name{};
  std::string func_arg_type{};
};

struct KFuzzTargetRaw FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef KFuzzTargetRawT NativeTableType;
  typedef KFuzzTargetRawBuilder Builder;
  enum FlatBuffersVTableOffset FLATBUFFERS_VTABLE_UNDERLYING_TYPE {
    VT_FUNC_NAME = 4,
    VT_FUNC_ARG_TYPE = 6
  };
  ...
  const ::flatbuffers::String *func_arg_type() const {
    return GetPointer<const ::flatbuffers::String *>(VT_FUNC_ARG_TYPE);
  }
  bool Verify(::flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           VerifyOffset(verifier, VT_FUNC_NAME) &&
           verifier.VerifyString(func_name()) &&
           VerifyOffset(verifier, VT_FUNC_ARG_TYPE) &&
           verifier.VerifyString(func_arg_type()) &&
           verifier.EndTable();
  }
  KFuzzTargetRawT *UnPack(const ::flatbuffers::resolver_function_t *_resolver = nullptr) const;
  void UnPackTo(KFuzzTargetRawT *_o, const ::flatbuffers::resolver_function_t *_resolver = nullptr) const;
  static ::flatbuffers::Offset<KFuzzTargetRaw> Pack(::flatbuffers::FlatBufferBuilder &_fbb, const KFuzzTargetRawT* _o, const ::flatbuffers::rehasher_function_t *_rehasher = nullptr);
};

struct KFuzzTargetRawBuilder {
  typedef KFuzzTargetRaw Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_func_name(::flatbuffers::Offset<::flatbuffers::String> func_name) {
    fbb_.AddOffset(KFuzzTargetRaw::VT_FUNC_NAME, func_name);
  }
  void add_func_arg_type(::flatbuffers::Offset<::flatbuffers::String> func_arg_type) {
    fbb_.AddOffset(KFuzzTargetRaw::VT_FUNC_ARG_TYPE, func_arg_type);
  }
  explicit KFuzzTargetRawBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<KFuzzTargetRaw> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<KFuzzTargetRaw>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<KFuzzTargetRaw> CreateKFuzzTargetRaw(
    ::flatbuffers::FlatBufferBuilder &_fbb,
    ::flatbuffers::Offset<::flatbuffers::String> func_name = 0,
    ::flatbuffers::Offset<::flatbuffers::String> func_arg_type = 0) {
  KFuzzTargetRawBuilder builder_(_fbb);
  builder_.add_func_arg_type(func_arg_type);
  builder_.add_func_name(func_name);
  return builder_.Finish();
}

inline ::flatbuffers::Offset<KFuzzTargetRaw> CreateKFuzzTargetRawDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
    const char *func_name = nullptr,
    const char *func_arg_type = nullptr) {
  auto func_name__ = func_name ? _fbb.CreateString(func_name) : 0;
  auto func_arg_type__ = func_arg_type ? _fbb.CreateString(func_arg_type) : 0;
  return rpc::CreateKFuzzTargetRaw(
      _fbb,
      func_name__,
      func_arg_type__);
}

::flatbuffers::Offset<KFuzzTargetRaw> CreateKFuzzTargetRaw(::flatbuffers::FlatBufferBuilder &_fbb, const KFuzzTargetRawT *_o, const ::flatbuffers::rehasher_function_t *_rehasher = nullptr);
...
struct InfoRequestRawT : public ::flatbuffers::NativeTable {
  ...
  std::vector<std::unique_ptr<rpc::KFuzzTargetRawT>> kfuzz_targets{};
...
struct InfoRequestRaw FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  ...
  const ::flatbuffers::Vector<::flatbuffers::Offset<rpc::KFuzzTargetRaw>> *kfuzz_targets() const {
    return GetPointer<const ::flatbuffers::Vector<::flatbuffers::Offset<rpc::KFuzzTargetRaw>> *>(VT_KFUZZ_TARGETS);
  }
  bool Verify(::flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           ...
           VerifyOffset(verifier, VT_KFUZZ_TARGETS) &&
           verifier.VerifyVector(kfuzz_targets()) &&
           verifier.VerifyVectorOfTables(kfuzz_targets()) &&
           verifier.EndTable();
  }
...
struct InfoRequestRawBuilder {
  ...
  void add_kfuzz_targets(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<rpc::KFuzzTargetRaw>>> kfuzz_targets) {
    fbb_.AddOffset(InfoRequestRaw::VT_KFUZZ_TARGETS, kfuzz_targets);
  }
...
inline ::flatbuffers::Offset<InfoRequestRaw> CreateInfoRequestRaw(
    ...
    ::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<rpc::KFuzzTargetRaw>>> kfuzz_targets = 0) {
  InfoRequestRawBuilder builder_(_fbb);
  builder_.add_kfuzz_targets(kfuzz_targets);
  builder_.add_files(files);
  builder_.add_features(features);
...
inline ::flatbuffers::Offset<InfoRequestRaw> CreateInfoRequestRawDirect(
    ...
    const std::vector<::flatbuffers::Offset<rpc::KFuzzTargetRaw>> *kfuzz_targets = nullptr) {
  ...
  auto kfuzz_targets__ = kfuzz_targets ? _fbb.CreateVector<::flatbuffers::Offset<rpc::KFuzzTargetRaw>>(*kfuzz_targets) : 0;
...
inline KFuzzTargetRawT *KFuzzTargetRaw::UnPack(const ::flatbuffers::resolver_function_t *_resolver) const {
  auto _o = std::unique_ptr<KFuzzTargetRawT>(new KFuzzTargetRawT());
  UnPackTo(_o.get(), _resolver);
  return _o.release();
}

inline void KFuzzTargetRaw::UnPackTo(KFuzzTargetRawT *_o, const ::flatbuffers::resolver_function_t *_resolver) const {
  (void)_o;
  (void)_resolver;
  { auto _e = func_name(); if (_e) _o->func_name = _e->str(); }
  { auto _e = func_arg_type(); if (_e) _o->func_arg_type = _e->str(); }
}

inline ::flatbuffers::Offset<KFuzzTargetRaw> KFuzzTargetRaw::Pack(::flatbuffers::FlatBufferBuilder &_fbb, const KFuzzTargetRawT* _o, const ::flatbuffers::rehasher_function_t *_rehasher) {
  return CreateKFuzzTargetRaw(_fbb, _o, _rehasher);
}

inline ::flatbuffers::Offset<KFuzzTargetRaw> CreateKFuzzTargetRaw(::flatbuffers::FlatBufferBuilder &_fbb, const KFuzzTargetRawT *_o, const ::flatbuffers::rehasher_function_t *_rehasher) {
  (void)_rehasher;
  (void)_o;
  struct _VectorArgs { ::flatbuffers::FlatBufferBuilder *__fbb; const KFuzzTargetRawT* __o; const ::flatbuffers::rehasher_function_t *__rehasher; } _va = { &_fbb, _o, _rehasher}; (void)_va;
  auto _func_name = _o->func_name.empty() ? 0 : _fbb.CreateString(_o->func_name);
  auto _func_arg_type = _o->func_arg_type.empty() ? 0 : _fbb.CreateString(_o->func_arg_type);
  return rpc::CreateKFuzzTargetRaw(
      _fbb,
      _func_name,
      _func_arg_type);
...
inline InfoRequestRawT::InfoRequestRawT(const InfoRequestRawT &o)
  ...
  kfuzz_targets.reserve(o.kfuzz_targets.size());
  for (const auto &kfuzz_targets_ : o.kfuzz_targets) { kfuzz_targets.emplace_back((kfuzz_targets_) ? new rpc::KFuzzTargetRawT(*kfuzz_targets_) : nullptr); }
}
...
inline InfoRequestRawT &InfoRequestRawT::operator=(InfoRequestRawT o) FLATBUFFERS_NOEXCEPT {
  ...
  std::swap(kfuzz_targets, o.kfuzz_targets);
  return *this;
}
...
inline void InfoRequestRaw::UnPackTo(InfoRequestRawT *_o, const ::flatbuffers::resolver_function_t *_resolver) const {
  ...
  { auto _e = kfuzz_targets(); if (_e) { _o->kfuzz_targets.resize(_e->size()); for (::flatbuffers::uoffset_t _i = 0; _i < _e->size(); _i++) { if(_o->kfuzz_targets[_i]) { _e->Get(_i)->UnPackTo(_o->kfuzz_targets[_i].get(), _resolver); } else { _o->kfuzz_targets[_i] = std::unique_ptr<rpc::KFuzzTargetRawT>(_e->Get(_i)->UnPack(_resolver)); } } } else { _o->kfuzz_targets.resize(0); } }
}
...
inline ::flatbuffers::Offset<InfoRequestRaw> CreateInfoRequestRaw(::flatbuffers::FlatBufferBuilder &_fbb, const InfoRequestRawT *_o, const ::flatbuffers::rehasher_function_t *_rehasher) {
  ...
  auto _kfuzz_targets = _o->kfuzz_targets.size() ? _fbb.CreateVector<::flatbuffers::Offset<rpc::KFuzzTargetRaw>> (_o->kfuzz_targets.size(), [](size_t i, _VectorArgs *__va) { return CreateKFuzzTargetRaw(*__va->__fbb, __va->__o->kfuzz_targets[i].get(), __va->__rehasher); }, &_va ) : 0;
  return rpc::CreateInfoRequestRaw(
      _fbb,
      _error,
      _features,
